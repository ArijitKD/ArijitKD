...
<br><br>
    Most of these are either in C or in Python. These two are
    my preferred programming languages, and cover almost all
    topics I am interested in (broadly, devtooling and embedded).
<br><br>
    Python is a great choice for CLI dev tools, especially for
    Linux/POSIX systems which come with a pre-installed Python
    interpreter. 
<br>
...
<br><br>
    ...
    because I had been absent-minded thinking of something and suddenly
    got the energy to do it (which is infrequent, and that's why some of
